...
public class PowerDatacenter extends Datacenter {
	...
	protected void updateCloudletProcessing() {
        ...
        UtilizationMonitor.getLoadstatistic(this.<ClusterHost>getHostList());
//        UtilizationMonitor.evaluateLoad((PowerVmAllocationPolicyMigrationDynamicThreshold) getVmAllocationPolicy());
